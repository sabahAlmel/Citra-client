...
import logoM from "../../assets/icons/logo.svg";
    ...
    <div className={navBarStyle.navContainer}>
      <nav className={navBarStyle.navBar}>
        ...
        >
          ...
          <span></span>
          <div>
            <img src={logoM} alt="logo mobile" 
              className={`${navBarStyle.navImg}  ${
                isResponsive ? navBarStyle.navimg : navBarStyle.navimgClose
              }`}/>
          </div>
        </div>
